...
enum TestImageFixture {
    static func makeCGImage(width: Int, height: Int, red: CGFloat = 1, green: CGFloat = 0, blue: CGFloat = 0) -> CGImage {
    ...
    static func makePNGData(width: Int, height: Int, red: CGFloat = 1, green: CGFloat = 0, blue: CGFloat = 0) -> Data {
        let cgImage = makeCGImage(width: width, height: height, red: red, green: green, blue: blue)
