...
struct KeyboardPreferencesTab: View {
    ...
    private func displayName(for action: ActionID) -> String {
        ...
        case .displayAsIcons: "common.icon"
        case .displayAsList: "common.list"
        case .increaseIconSize: "action.increaseIconSize"
        case .decreaseIconSize: "action.decreaseIconSize"
        case .toggleSidebar: "action.toggleSidebar"
        case .toggleInspector: "action.toggleInspector"
        case .togglePathBar: "action.togglePathBar"
        case .toggleStatusBar: "action.toggleStatusBar"
        case .eject: "action.eject"
        case .ejectAll: "action.ejectAll"
