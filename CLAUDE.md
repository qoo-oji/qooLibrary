...
| 2-14 | 未解決／孤立ファイルの整理ウインドウ | **2-2 で孤立が日常的に発生するようになった**ので、片付ける手段の必要度が上がった |
...
| 2-14 | 未解決／孤立ファイルの整理ウインドウ | `unresolvedFile` に誰も書いていないので **2-7 の記録側から**要る |
