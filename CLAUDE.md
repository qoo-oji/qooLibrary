...
| 2-6 の残り | ラベルグループ・ラベルの編集ウインドウ [LE-01〜12] | リポジトリと配色は済んでいる。**ラベルフィルタから改名・統合・保管庫へ送る導線が無い** |
...
| 2 | **ラベルフィルタからラベルを編集する導線が無い**（改名・統合・保管庫へ [LB-06][LB-07][LA-01]）。2-6 の編集ウインドウの担当 |
...
| # | 内容 |
|---|---|
| 1 | 実機で未確認: 「もっと見る」を押した後の検索欄 [PN-05]（合成入力の制約）／アーカイブ済みラベルの出し分け [LA-03][RL-05]（アーカイブする GUI 経路が 2-6 まで無い）。どちらも自動テストでは固定済み |
| 2 | ラベルの改名・統合・保管庫へ送る [LB-06][LB-07][LA-01]、ラベル固有色の編集 [LE-10][CO-06] — 2-6 のラベル編集ウインドウの担当。**ラベルフィルタからも右ペインからも、そこへ送る導線がまだ無い** |
