...
> **次に着手する人へ**: フェーズ 1 が実際に完了したので、§6 が定める**フェーズ完了時のリソースリーク・ファイル安全性監査**を実施すること。以前 1-14/1-15/1-16 が未着手の段階で前倒しに実施した記録が §0 にあるが、**あれは正式な「フェーズ1完了時点の監査」の代替にはならない**（ユーザーから明確な訂正を受けている）。1-14〜1-17 を含めて改めて行う。
